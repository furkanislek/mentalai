    ...
    <div className="relative w-full h-full flex flex-col justify-center px-[5%] overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto hidden md:grid md:grid-cols-3 md:gap-12 md:items-center relative">
        ...
        <div className="z-10 mb-0">
          ...
          <Link
            href="/get-started"
            className="inline-block bg-[#3a4c39] mt-6 text-white px-8 py-3 hover:bg-[#2c3c2b] transition"
            aria-label="Get Started with MentalHeal"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="relative z-10 mx-auto w-full max-w-[350px]">
          <div className="rounded-3xl overflow-hidden">
            <Image
              src="/photos/1.jpg"
              alt="Person meditating with AI assistance visualization"
              width={800}
              height={800}
        ...
        <div className="z-10 text-right">
          <div className="mb-12">
            ...
            <p className="text-[#444444]">Active Users</p>
          </div>

          <div className="mb-70">
            <h3 className="text-5xl text-[#282828]">65K</h3>
            <p className="text-[#444444]">Therapy Sessions</p>
          </div>
        ...
        <div className="w-full z-10">
          ...
          <div className="flex justify-center space-x-14 mb-10 w-full">
            <div className="text-center">
              ...
              <p className="text-[#444444] text-sm">Active Users</p>
            </div>

            <div className="text-center">
              <h3 className="text-3xl sm:text-4xl text-[#282828]">65K</h3>
              <p className="text-[#444444] text-sm">Therapy Sessions</p>
            </div>
          </div>
          ...
          <div className="text-center mb-6">
            ...
            <Link
              href="/get-started"
              className="inline-block bg-[#3a4c39] text-white px-6 sm:px-8 py-2 sm:py-3 hover:bg-[#2c3c2b] transition"
              aria-label="Get Started with MentalHeal"
            >
              Get Started
            </Link>
